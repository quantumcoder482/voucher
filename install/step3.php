        ...
        <form action="" method="post" id="ib_form">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <span class='help-block'>To install this software, you need a valid purchase key or order number. You can retrieve it from here- <a href="https://app.cloudonex.com/orders" target="_blank">https://app.cloudonex.com/orders</a> </span>
                </div>
