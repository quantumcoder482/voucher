                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="bill-data text-right">
                                        ...
                                        <h2> {$_L['Invoice Total']}: <span class="amount" data-a-sign="{$data_a_sign}" data-a-dec="{$data_a_dec}" data-a-sep="{$data_a_sep}" data-p-sign="{$data_p_sign}">{$d['total']}</span> </h2>
                                ...
                                <table class="table table-bordered invoice-items">
                                    ...
                                    {foreach $items as $item}
                                        <tr>
                                            ...
                                            <td class="text-right amount" data-a-sign="{$data_a_sign}" data-a-dec="{$data_a_dec}" data-a-sep="{$data_a_sep}" data-p-sign="{$data_p_sign}">{$item['amount']*$item['qty']}</td>
                                            ...
                                            {else}
                                                ...
                                                <td class="text-right">
                                                    <span class="amount" data-a-sign="{$data_a_sign}" data-a-dec="{$data_a_dec}" data-a-sep="{$data_a_sep}" data-p-sign="{$data_p_sign}">{round(( ($item['tax_rate']*100) / ($item['qty'] * $item['amount'])),2)}</span> <br>
                                                    @{round($item['tax_rate'],2)}%
                                ...
                                <table class="table table-bordered invoice-items">
                                    ...
                                    {foreach $items as $item}
                                        <tr>
                                            ...
                                            <td class="text-center">{$item['qty']}</td>
                                            <td class="text-center amount" data-a-sign="{$data_a_sign}" data-a-dec="{$data_a_dec}" data-a-sep="{$data_a_sep}" data-p-sign="{$data_p_sign}">{$item['total']}</td>
                                        </tr>
                                    {/foreach}
                                    </tbody>
                                </table>
