                    ...
                    <table class="table invoice-items">
                        ...
                        {foreach $items as $item}
                            <tr>
                                ...
                                <td class="text-center">{$config['currency_code']} {number_format($item['amount'],2,$config['dec_point'],$config['thousands_sep'])}</td>
                                <td class="text-center">{$item['qty']}</td>
                                <td class="text-center">{$config['currency_code']} {number_format($item['total'],2,$config['dec_point'],$config['thousands_sep'])}</td>
                            </tr>
                        {/foreach}
