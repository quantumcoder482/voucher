            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav nav-highlight" id="side-menu">
                    ...
                    {if isset($config['client_has_sub_client']) && $config['client_has_sub_client'] == 1}
                        ...
                        <li {if $_application_menu eq 'end_users'}class="active"{/if}><a href="#"><i class="icon-users"></i> <span class="nav-label">End users</span><span class="fa arrow"></span></a>

                            <ul class="nav nav-second-level">
                                <li><a href="{$_url}client/end_users/">End users</a></li>
                                <li><a href="{$_url}client/end_users/user/">Create new end user</a></li>
                            </ul>
                        </li>
